...
pub fn main() {
    ...
    let res_1 = Solution::two_sum_perf(test_case1.clone(), target_1).unwrap();
    println!(
        "{} + {} = {}",
    ...
    let res2 = Solution::two_sum_as_i32_perf(test_case2.clone(), target2);
    println!(
        "{} + {} = {}",
...
mod tests {
    ...
    fn first_two_success() {
        ...
        let res_1 = Solution::two_sum(test_case1.clone(), target_1);
        let perf_res_1 = Solution::two_sum_perf(test_case1.clone(), target_1);
        let res_i32_1 = Solution::two_sum_as_i32(test_case1.clone(), target_1);
        let perf_res_i32_1 = Solution::two_sum_as_i32_perf(test_case1.clone(), target_1);
    ...
    fn no_sum_matches_target_i32_panic() {
        let target_1: i32 = 0;
        let test_case1: Vec<i32> = vec![1, 3, 9, 4, 13];
        let _ = Solution::two_sum_as_i32(test_case1.clone(), target_1);
    }
    ...
    fn no_sum_matches_target_i32_perf_panic() {
        let target_1: i32 = 0;
        let test_case1: Vec<i32> = vec![1, 3, 9, 4, 13];
        let _ = Solution::two_sum_as_i32_perf(test_case1.clone(), target_1);
    }
