...
mod tests {
    ...
    fn success1() {
        ...
        let output1 = 3;
        let res1 = longest_substring(input_str1.to_string());
    ...
    fn success2() {
        ...
        let output2 = 1;
        let res2 = longest_substring(input_str2.to_string());
    ...
    fn success3() {
        ...
        let output3 = 3;
        let res3 = longest_substring(input_str3.to_string());
    ...
    fn success4() {
        ...
        let input_str4 = "aab";
        let output4 = 2;
        let res4 = longest_substring(input_str4.to_string());
    ...
    fn success5() {
        ...
        let input_str5 = "dvdf";
        let output5 = 3;
        let res5 = longest_substring(input_str5.to_string());
